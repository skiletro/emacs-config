...
- [[#todo][Todo]]
  - [[#finish-dashboard][Finish dashboard]]
  - [[#auto-load-lsp-when-opening-supported-files][Auto-load LSP when opening supported files]]
  - [[#add-more-language-servers][Add more language servers]]
  - [[#learn-and-properly-utilise-dired][Learn and properly utilise dired]]
...
** TODO Auto-load LSP when opening supported files
...
** TODO Learn and properly utilise dired
